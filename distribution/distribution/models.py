...
class MailingSettings(models.Model):
    ...
    client = models.ManyToManyField(Service_client, verbose_name='клиенты рассылки')
...
class Logs(models.Model):
    ...
    client = models.ForeignKey(Service_client, on_delete=models.CASCADE, verbose_name='клиент', **NULLABLE)
